     ...
     class SyncData extends AsyncTask<String, String, String>{
        ...
        protected void onPostExecute(String msg) {
...

            {
                ...
                try {
                    myAppdater = new MyAppdater(datalist, Home_Eployess.this, new CustomItemClickListener() {
                        @Override
...
//                    });
    ...
    private void Logout(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home_Eployess.this);
